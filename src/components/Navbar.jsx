      ...
      <nav className="bg-white dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <div className="flex items-center space-x-3 md:space-x-0 rtl:space-x-reverse gap-4">
              <Link to="/cart">
                <svg
              ...
              <div>
                ...
                >
                  <img class="w-10 h-10 rounded-full cursor-pointer" src="https://img.freepik.com/free-photo/androgynous-avatar-non-binary-queer-person_23-2151100221.jpg" alt="Rounded avatar" />
                </button>
                <div
                  id="dropdownNavbar"
